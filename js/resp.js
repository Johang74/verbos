...
(function (compId) {
  ...
  function doLoadResources() {
    for (var a = 0; a < AdobeEdge._preloaders.length; a++)
      AdobeEdge._preloaders[a]();
  }
  ...
  function playWhenReady() {
    ...
    for (var a = 0; a < AdobeEdge._readyplayers.length; a++)
      AdobeEdge._readyplayers[a]();
  }
  function edgeCallback(a, d, b) {
    htFallbacks[a] && (a = htFallbacks[a]);
    AdobeEdge.preload.got[a] = !0;
    a == AdobeEdge.preload.last &&
      (!AdobeEdge.bootstrapLoading || AdobeEdge._playWhenReady
        ? AdobeEdge.okToLaunchComposition(compId)
        : (readyToPlay = !0),
      (AdobeEdge.preload.busy = !1),
      0 < AdobeEdge.preload.q.length &&
        ((a = AdobeEdge.preload.q.pop()),
        AdobeEdge.requestResources(a.files, a.callback)));
  }
  AdobeEdge.requestResources =
    AdobeEdge.requestResources ||
    function (a, d) {
      ...
      for (b = 0; b < g; b++) {
        ...
        AdobeEdge.preload.got[url] ||
          (f.push(c), (AdobeEdge.preload.last = url));
      }
  ...
  function loadResources(a, d) {
    ...
    d || !isCapable()
      ? (filesToLoad = a)
      : AdobeEdge.preload.busy
      ? AdobeEdge.preload.q.push({ files: a, callback: edgeCallback })
  ...
  function bindPSS(a, d) {
    if (!isWrapped(a)) {
      var b = function () {
        ...
        l.oTransform = h;
        if (!f || b)
          (parent(a).style.height = Math.round(n * e) + "px"),
            (parent(a).style.width = Math.round(k * e) + "px");
        b &&
          ((b = parent(parent(a))),
          (b.style.height = Math.round(n * e + offset(a).top - offset(b).top)));
      };
  ...
  function centerThePreloadStage(a, d) {
    ...
    var b = a.style;
    /^both$|^horizontal$/.test(d) &&
      ((b.position = "absolute"),
      (b.marginLeft = "auto"),
      (b.marginRight = "auto"),
      (b.left = "0"),
      (b.right = "0"));
    /^both$|^vertical$/.test(d) &&
      ((b.position = "absolute"),
      (b.marginTop = "auto"),
      (b.marginBottom = "auto"),
      (b.top = "0"),
  ...
  function simpleContent(a, d, b) {
    ...
    for (var n = 0; n < a.length; n++) {
      b = a[n];
      "image" === b.type
        ? ((g = document.createElement("img")), (g.src = b.fill[1]))
        : (g = document.createElement("div"));
      g.id = b.id;
      k = g.style;
      if ("text" == b.type) {
        if ((c = b.font))
          c[0] && "" !== c[0] && (k.fontFamily = c[0]),
            "object" != typeof c[1] && (c[1] = [c[1]]),
            c[1][1] || (c[1][1] = "px"),
            c[1][0] && "" !== c[1][0] && (k.fontSize = c[1][0] + c[1][1]),
            c[2] && "" !== c[2] && (k.color = safeColor(c[2])),
            c[3] && "" !== c[3] && (k.fontWeight = c[3]),
            c[4] && "" !== c[4] && (k.textDecoration = b.font[4]),
            c[5] && "" !== c[5] && (k.fontStyle = b.font[5]);
      ...
      if (b.transform && b.transform[0]) {
        ...
        if (e && e.units && ((m = e.num), "%" == e.units && b.rect[2])) {
          ...
          l &&
            l.units &&
            ((e = l.num), "%" == l.units && (e = (e / 100) * f.offsetWidth));
          m = (m / 100) * e;
        ...
        if (1 < b.transform[0].length) {
          ...
          (e = splitUnits(m)) &&
            ...
            "%" == e.units &&
              b.rect[3] &&
              ((e = b.rect[3]),
              (l = splitUnits(b.rect[3])) &&
                l.units &&
                ((e = l.num),
                "%" == l.units && (e = (e / 100) * f.offsetHeight)),
              (m = (m / 100) * e),
              0 < f.offsetHeight && (m = (m / f.offsetHeight) * 100)));
      ...
      b.linkURL &&
        ...
        (g.onclick = function () {
          ...
          a.linkTarget
            ? window.open(a.linkURL, a.linkTarget)
            : (window.location.href = a.linkURL);
        }),
        (k.cursor = "pointer"));
      f.appendChild(g);
      if (b.c) for (k = 0; k < b.c.length; k++) simpleContent(b.c[k], d, g);
    }
  }
  var fnCycle = function (a) {
      a
        ? fnCycle && setTimeout(fnCycle, 20)
        : (a = { event: "loading", progress: 0 });
  ...
  window.AdobeEdge.preloadComplete[compId] = function (a) {
    ...
    for (var d = window.AdobeEdge.bootstrapListeners.length, b = 0; b < d; b++)
      try {
  ...
  function onDocLoaded(a) {
    ...
    isCapable()
      ? (preContent &&
          preContent.dom &&
          preContent.dom.length &&
          simpleContent(preContent.dom, "edgePreload" + compId),
        filesToLoad &&
          !signaledLoading &&
          (loadResources(filesToLoad), (filesToLoad = void 0)))
      : dlContent &&
        dlContent.dom &&
        (loadingEvt &&
